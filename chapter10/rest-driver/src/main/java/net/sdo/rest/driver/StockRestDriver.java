...
public class StockRestDriver {
  ...
  public StockRestDriver () {
    ...
    String url = "http://" + host + ":" + port + "/" + "java-performance/rest/StockPrice";
    stockRest1YrURL = url + "?mode=1&startDate=01%2F01%2F2013&endDate=12%2F31%2F2013&cache=" + cache;// + "&symbol=AAAA";
    stockRest1YrNoDataURL = url + "?mode=0&startDate=01%2F01%2F2013&endDate=12%2F31%2F2013&cache=" + cache;// + "&symbol=AAAA";
    stockRest5CallsURL = url + "?mode=0&startDate=01%2F01%2F2013&endDate=01%2F07%2F2013&cache=" + cache;// + "&symbol=AAAA";
    stockRest2YrURL = url + "?mode=1&startDate=01%2F01%2F2013&endDate=12%2F31%2F2014&cache=" + cache;// + "&symbol=AAAA";
    stockRest6MonthsURL = url + "?mode=1&startDate=01%2F01%2F2013&endDate=06%2F30%2F2013&cache=" + cache;// + "&symbol=AAAA";
    stockRest5YrURL = url + "?mode=1&startDate=01%2F01%2F2013&endDate=12%2F31%2F2017&cache=" + cache;// + "&symbol=AAAA";
  ...
  @BenchmarkOperation(name = "StockRest1Yr", max90th = 1000., timing = Timing.MANUAL)
  ...
  @BenchmarkOperation(name = "StockRest1YrNoData", max90th = 1000., timing = Timing.MANUAL)
  ...
  @BenchmarkOperation(name = "StockRest5Calls", max90th = 1000., timing = Timing.MANUAL)
  ...
  @BenchmarkOperation(name = "StockRest2Calls", max90th = 1000., timing = Timing.MANUAL)
  ...
  @BenchmarkOperation(name = "StockRest10Calls", max90th = 1000., timing = Timing.MANUAL)
  ...
  @BenchmarkOperation(name = "StockRest2Yr", max90th = 1000., timing = Timing.MANUAL)
  ...
  @BenchmarkOperation(name = "StockRest6Months", max90th = 1000., timing = Timing.MANUAL)
  ...
  @BenchmarkOperation(name = "StockRest5Yr", max90th = 1000., timing = Timing.MANUAL)
